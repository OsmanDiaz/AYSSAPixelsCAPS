...
{
    public class CMenuSistema : CSqlvars
    {
        public CMenuSistema(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TBC_SIS Detalle(string Id, string DescMenu, string Descripcion, int OrdenMenu,
             string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TBC_MENU_SISTEMA_GetByAll", ObjConnection);
                ObjParam = new SqlParameter();
                ObjAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;

                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID", Id);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_DESC_MENU", DescMenu);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_DESCRIPCION", Descripcion);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@NM_ORDEN_MENU", OrdenMenu);
                ...
                ObjAdapter.Fill(objDataSet, "TBC_MENU_SISTEMA");
                ObjConnection.Close();
            ...
            try
            {
                ...
                switch (OpcionActualizacion)
                {
                    case TipoActualizacion.Adicionar:
                        StrCommand = "SP_TBC_MENU_SISTEMA_INSERT";
                        break;
                    case TipoActualizacion.Actualizar:
                        StrCommand = "SP_TBC_MENU_SISTEMA_UPDATE";
                        break;
                    case TipoActualizacion.Eliminar:
                        StrCommand = "SP_TBC_MENU_SISTEMA_DELETE";
                        break;

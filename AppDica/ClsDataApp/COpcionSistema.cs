...
{
    public class COpcionSistema : CSqlvars
    {
        public COpcionSistema(string ConexionSistema)
        {
            _ConexionData = ConexionSistema;
        }

        public ClsDataSets.DS_TBC_SIS Detalle(string Id, string CodiOpciSist, string NombreForma, string RutaForma, string Descripcion,
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TBC_OPCION_SISTEMA_GetByAll", ObjConnection);
                ObjParam = new SqlParameter();
                ObjAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;

                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID", Id);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_CODI_OPCI_SIST", CodiOpciSist);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_NOMBRE_FORMA", NombreForma);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_RUTA_FORMA", RutaForma);
                ...
                ObjAdapter.Fill(objDataSet, "TBC_OPCION_SISTEMA");
                ObjConnection.Close();
            ...
            try
            {
                ...
                switch (OpcionActualizacion)
                {
                    case TipoActualizacion.Adicionar:
                        StrCommand = "SP_TBC_OPCION_SISTEMA_INSERT";
                        break;
                    case TipoActualizacion.Actualizar:
                        StrCommand = "SP_TBC_OPCION_SISTEMA_UPDATE";
                        break;
                    case TipoActualizacion.Eliminar:
                        StrCommand = "SP_TBC_OPCION_SISTEMA_DELETE";
                        break;

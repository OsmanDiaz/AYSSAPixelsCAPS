    ...
    public class CPasantiaActividadAspirante :CSqlvars
    {
             ...
             string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TB_PASANTIA_ACTIVIDAD_ASPIRANTE_GetByAll", ObjConnection);
                ...
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID_PASANTIA_ACTIVIDAD", IdPasantiaAct);
                ...
                ObjAdapter.Fill(objDataSet, "TB_PASANTIA_ACTIVIDAD_ASPIRANTE");
            ...
            int OpcionConsulta, string LoginUsuario, TipoActualizacion OpcionActualizacion)
        {
            ...
            try
            {
                ...
                ObjCommand.Parameters.AddWithValue("@ID_PASANTIA_ACTIVIDAD", IdPasantiaAct);

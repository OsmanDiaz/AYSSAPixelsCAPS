...
{
    public class COpcionRespuestaEncuesta:CSqlvars
    {
        public COpcionRespuestaEncuesta(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TB_EMP Detalle(int Id, string OpcionRespuesta, int IdPreguntaEncuesta, char Estado, string UsuaCrea, DateTime FechCrea, string UsuaActu,
        DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TBC_OPCION_RESPUESTA_ENCUESTA_GetByAll", ObjConnection);
                ObjParam = new SqlParameter();
                ObjAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;

                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID", Id);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_PREGUNTA", OpcionRespuesta);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID_PREGUNTA_ENCUESTA", IdPreguntaEncuesta);
        ...
        public DataQuery Actualizacion(int Id, string OpcionRespuesta, int IdPreguntaEncuesta, char Estado, string LoginUsuario, TipoActualizacion OpcionActualizacion)
        {
            ...
            try
            {
                ...
                switch (OpcionActualizacion)
                {
                    case TipoActualizacion.Adicionar:
                        StrCommand = "SP_TBC_OPCION_RESPUESTA_ENCUESTA_INSERT";
                        break;
                    case TipoActualizacion.Actualizar:
                        StrCommand = "SP_TBC_OPCION_RESPUESTA_ENCUESTA_UPDATE";
                        break;
                    case TipoActualizacion.Eliminar:
                        StrCommand = "SP_TBC_OPCION_RESPUESTA_ENCUESTA_DELETE";
                        break;
                    case TipoActualizacion.No_Definida:
                        objResultado.CodigoError = -1;
                        objResultado.MensajeError = "Opcion de Actualizacion No Definida. Objeto COpcionesRespuestaEncuestas. Metodo Actualizacion";
                        //return objResultado;
                        break;
                }
                ...
                ObjCommand.Parameters.AddWithValue("@DS_PREGUNTA", OpcionRespuesta);
                ObjCommand.Parameters.AddWithValue("@ID_PREGUNTA_ENCUESTA", IdPreguntaEncuesta);

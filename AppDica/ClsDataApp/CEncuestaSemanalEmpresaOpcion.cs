...
{
    public class CEncuestaSemanalEmpresaOpcion :CSqlvars
    {
        public CEncuestaSemanalEmpresaOpcion(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TB_EMP Detalle(int Id,string Respuesta1, string Respuesta2, string Respuesta3, 
        string Respuesta4, string Respuesta5, string Respuesta6, int IdPregunta, int IdRespuestaEncuestaEmp, 
        string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TB_ENCUESTA_SEMANAL_EMPRESA_OPCION_GetByAll", ObjConnection);
                ...
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID_PREGUNTA", IdPregunta);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@ID_ENCUESTA_SEM_EMPRESA", IdRespuestaEncuestaEmp);
        ...
        public DataQuery Actualizacion(int Id, string Respuesta1, string Respuesta2, string Respuesta3,
        string Respuesta4, string Respuesta5, string Respuesta6, int IdPregunta, int IdRespuestaEncuestaEmp, 
            ...
            try
            {
                ...
                switch (OpcionActualizacion)
                {
                    case TipoActualizacion.Adicionar:
                        StrCommand = "SP_TB_ENCUESTA_SEMANAL_EMPRESA_OPCION_INSERT";
                        break;
                    case TipoActualizacion.Actualizar:
                        StrCommand = "SP_TB_ENCUESTA_SEMANAL_EMPRESA_OPCION_UPDATE";
                        break;
                    case TipoActualizacion.Eliminar:
                        StrCommand = "SP_TB_ENCUESTA_SEMANAL_EMPRESA_OPCION_DELETE";
                        break;
                ...
                ObjCommand.Parameters.AddWithValue("@ID_PREGUNTA", IdPregunta);                
                ObjCommand.Parameters.AddWithValue("@ID_ENCUESTA_SEM_EMPRESA", IdRespuestaEncuestaEmp);

...
{
    public class CInformeFinalComparativo : CSqlvars
    {
        public CInformeFinalComparativo(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_TB_ASP Detalle(int Id,int IdPasantia, string AprendidoComparativo, string PuestoEnPractica,
            string UsuaCrea, DateTime FechCrea, string UsuaActu, DateTime FechActu, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("SP_TB_INFORME_FINAL_COMPARATIVO_GetByAll", ObjConnection);
                ...
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_APRENDIDO_PIXELS", AprendidoComparativo);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_PRACTICA_EMPRESA", PuestoEnPractica);
                ...
                ObjAdapter.Fill(objDataSet, "TB_INFORME_FINAL_COMPARATIVO");
        ...
        public DataQuery Actualizacion(int Id, int IdPasantia, string AprendidoComparativo, string PuestoEnPractica,
            ...
            try
            {
                ...
                switch (OpcionActualizacion)
                {
                    case TipoActualizacion.Adicionar:
                        StrCommand = "SP_TB_INFORME_FINAL_COMPARATIVO_INSERT";
                        break;
                ...
                ObjCommand.Parameters.AddWithValue("@DS_APRENDIDO_PIXELS", AprendidoComparativo);
                ObjCommand.Parameters.AddWithValue("@DS_PRACTICA_EMPRESA", PuestoEnPractica);
